...
public class NCCCTransDataBean {
    public static final String TRANS_TYPE_SALE = "01";
    ...
    private String esvcIndicator = "N";
    ...
    public static String getTransData(int amount, String date, String time) {
    ...
    * */
    public static String getSearchTransData(int amount, String date, String time) {
        NCCCTransDataBean dataBean = new NCCCTransDataBean();
    ...
    public static int parseAmount(String transAmount) {
        ...
        return ComputationUtils.parseInt(transAmount);
    }
